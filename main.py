...
#حقوق محمد
ownerID = int("5825563253") #ايدي الادمن 
api_hash = "4040917ceee8cf48c0ea217fcdc84250" #ايبي هاش 
api_id = 28803961 #ايبي ايدي
token = "6716769425:AAFVBj9WKc9eARN5J423IeOXXHDJ0KAEITQ" #توكن البوت
...
async def start_msg(app, message):
      reply_markup = ReplyKeyboardMarkup(
        ...
        resize_keyboard=True, placeholder='FoR More @VebThon ,@C35CS'
      )
      await message.reply('''
‌‎‌‎⿻┊Hello {},
‌‎‌‎⿻┊THiS BoT DeDicAtEd tO eXtRaCtinG
‌‎⿻┊ThE TeRmuX TeleGraM SesSioN
‌‎⿻┊ExTrAcT ThE SesSioN YoU WanT
